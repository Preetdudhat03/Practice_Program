...
{  
    ...
    {     
        ...
        setResizable(false);           //Disabling resize 
    }  
    ...
    {  
        ...
        if (userValue.equals("test1@gmail.com") && passValue.equals("test")) {  //if authentic, navigate user to a new page  
            ...
            //show error message  
            JOptionPane.showMessageDialog(this, "Enter Valid user name and password");
            textField1.setText("");
            textField2.setText(""); 
        }  
    }  
...
{  
    ...
    {  
        ...
        {  
            ...
            form.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);// closes frame 
